...
import com.example.warmrice.databinding.FragmentAccountFavouritedPostsBinding
import com.example.warmrice.util.PostAdapter

class AccountFavouritedPostsFragment : Fragment() {

    private lateinit var binding: FragmentAccountFavouritedPostsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentAccountFavouritedPostsBinding.inflate(inflater, container, false)
